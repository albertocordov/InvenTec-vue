...
export default {
  ...
  methods: {
    ...
    cerrarDialogEditar() {
      // Lógica para guardar los cambios del formulario (si es necesario)
      this.dialogEditar = false;
    },
    verDetalle() {
      // Lógica para ver el detalle (puedes implementar esta función)
    },
  },
};
</script>
...
th:first-child,
td:first-child {
  /* Estilo para la primera columna (Fecha) */
  min-width: 100px;
}
